...
import '../../HomepageReviews/ShowHomepageReviews/ShowHomepageReviews.css'
import '../../HomepageReviews/ShowHomepageReviews/ShowReviewsMobile.css'

const ShowReviews = (props) => {
    const {name, productName, userImg, productImg, ratings, review, dateOfReview} = props.reviews;
    return (
    <>
